...
#SBATCH -J meshgraphkan_elastostate
#SBATCH -o meshgraphkan_elastostate.out
#SBATCH -e meshgraphkan_elastostate.err
#SBATCH -p gpu
...
echo "  - Reimplemented in PyG due to DGL/PyTorch 2.7.0 incompatibility"
echo "================================================================"

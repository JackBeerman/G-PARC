...
#SBATCH -J mgkan_eval_elasto
#SBATCH -o mgkan_eval_elasto.out
#SBATCH -e mgkan_eval_elasto.err
#SBATCH -p gpu
#SBATCH --gres=gpu
#SBATCH -t 00:30:00
#SBATCH -c 4

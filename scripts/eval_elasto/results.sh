...
DATA_ROOT="/scratch/jtb3sud/processed_elasto_plastic/global_max/normalized"
...
MGKAN_CKPT="/scratch/jtb3sud/elasto_meshgraphkan/run1/best_model.pth"
MGN_CKPT="/scratch/jtb3sud/meshgraphnet_baseline/best_model.pt"
MGN_STATS="/scratch/jtb3sud/meshgraphnet_baseline/normalization_stats.pt"

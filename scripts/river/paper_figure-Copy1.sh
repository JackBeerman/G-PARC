...
echo ""
echo "================================================================"
echo "  RUN 1: G-PARC comparison figures"
echo "  Rows: GT | G-PARC | G-PARC (w/o MLS) | MeshGraphKAN"
echo "================================================================"
...
# ============================================================
# RUN 2: Baseline comparison (GT + MeshGraphNet + GraphSAGE)
# ============================================================
echo ""
echo "================================================================"
echo "  RUN 2: Baseline figures"
echo "  Rows: GT | MeshGraphNet | GraphSAGE"
echo "================================================================"
...
echo ""
echo "End: $(date)"
echo "✅ G-PARC figures in $OUTPUT_DIR/gparc"
echo "✅ Baseline figures in $OUTPUT_DIR/baselines"
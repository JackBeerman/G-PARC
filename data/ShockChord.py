            ...
            try:
                ...
                for start_idx in range(0, max_start + 1, self.stride):
                    ...
                    for offset in range(self.seq_len):
                        ...
                        # Extract global attributes if they exist and attach to data object
                        if hasattr(data_t, 'pressure'):
                            data_t.global_pressure = data_t.pressure
                        if hasattr(data_t, 'density'):
                            data_t.global_density = data_t.density  
                        if hasattr(data_t, 'delta_t'):
                            data_t.global_delta_t = data_t.delta_t
                        ...
                        # Note: y should already contain the next timestep's ground truth from preprocessing
                        # If not, you can uncomment the following lines:
                        # if t + 1 < len(sim_data):
                        #     data_tplus1 = sim_data[t + 1]
